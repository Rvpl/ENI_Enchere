...
<body>
	...
	<div class="container text-center fs-5 mt-5 w-25 p-3">
		<form action="${pageContext.request.contextPath}/newArticle"
			...
			<div class="form-group row mb-2">
				<label class="col-auto col-form-label w-25">Début de
					l'enchère:</label>
				<div class="col-md-6">
			...
			<div class="form-group row mb-2">
				<label class="col-auto col-form-label w-25">Fin de
					l'enchère:</label>
				<div class="col-md-6">
			...
			<div class="form-group row mb-3">
				...
				<div class="col-md-6">
					<input name="rue" type="text"
						value="${sessionScope.utilisateur.rue}" class="form-control">
				</div>
			</div>
			...
			<div class="form-group row mb-2">
				...
				<div class="col-md-6">
					<input name="ville" type="text"
						value="${sessionScope.utilisateur.ville}" class="form-control">
				</div>
			</div>
			...
			<div class="form-group row mb-2">
				...
				<div class="col-md-6 text-right">
					<button class="btn btn-danger mt-3 fw-bolder">
