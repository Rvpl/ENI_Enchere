...
<body style="text-align: center">
	...
	<div class="container">
		<form action="${pageContext.request.contextPath}/newArticle"
			...
			<div class="row">
				<div class="col-12">
					<label>Article: </label> <input name="nomArticle" type="text">
				</div>
				<div class="col-12">
				...
				<div class="col-12">
					<label>Catégorie :</label> <select name="choixCategorie">
				...
				<div class="col-12">
					<label>Mise à prix :</label> <input name="prix" type="number">
				</div>

				<div class="col-12">
					<label>Début de l'enchère : </label> <input name="date_debut"
						type="date">
				</div>
				<div class="col-12">
					<label>Fin de l'enchère : </label> <input name="date_fin"
						type="date">
				</div>

				<h3>Retrait</h3>
				<div class="col-12">
					<label>Rue :</label> <input name="rue" type="text"
				...
				<input type="hidden" name="util"
					value="${sessionScope.utilisateur.noUtil}">
